...
/***/ "./admin/assets/images/no-data.png":
/*!*****************************************!*\
  !*** ./admin/assets/images/no-data.png ***!
  \*****************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "images/no-data.37125a4c.png";
...
/*!****************************************!*\
  !*** ./admin/views-react/services.jsx ***!
  \****************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
...
const Services = () => {
  ...
  const [createFormData, setCreateFormData] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)({
    name: "",
    duration: "",
    price: "",
    description: ""
  ...
  const handleSubmit = async e => {
    ...
    try {
      const response = await fetch(`${bookingProService.api_base_url}create-service`, {
        method: "POST",
        headers: {
  ...
  const [serviceData, setServiceData] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)([]);
  const [currentPage, setCurrentPage] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(1);
  const [totalPages, setTotalPages] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)();
  const itemsPerPage = 10;
  const [refreshKey, setRefreshKey] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(0);
  const getServiceData = () => {
    fetch(`${bookingProService.api_base_url}get-services?page=${currentPage}&limit=${itemsPerPage}`, {
      method: "GET",
      headers: {
        "X-WP-Nonce": bookingProService.nonce
      }
  ...
  const handleDelete = async id => {
    ...
    if (confirmDelete) {
      try {
        const response = await fetch(`${bookingProService.api_base_url}delete-service/${id}`, {
          method: "DELETE",
          headers: {
            "X-WP-Nonce": bookingProService.nonce
          }
  ...
  const [updateFormData, setUpdateFormData] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)({
    id: "",
    name: "",
    duration: "",
    price: "",
  ...
  const handleUpdate = async e => {
    ...
    try {
      const response = await fetch(`${bookingProService.api_base_url}update-service`, {
        method: "POST",
        headers: {
          "X-WP-Nonce": bookingProService.nonce
        },
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.Fragment, {
    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("div", {
      className: "bp-service-container",
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_components_Header__WEBPACK_IMPORTED_MODULE_3__["default"], {
        ...
        className: "bp-ser-content",
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("div", {
          className: "bp-ser-cont-inner",
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("div", {
            className: "bp-ser-ci-top",
            ...
            className: "bp-ser-ci-second",
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("table", {
              className: "bp-ser-table",
              children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("thead", {
                className: "bp-ser-table-head",
                ...
                children: serviceData.map((service, index) => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("tr", {
                  className: "bp-ser-table-item",
                  children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("td", {
                    ...
                    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("span", {
                      className: service.status === "active" ? "status-active" : "status-inactive",
            ...
            }), serviceData.length === 0 && !loading && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("div", {
        ...
        className: "add-service-popup",
        children: isOpen && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("div", {
...
const initServices = () => {
  ...
  if (servicesDiv) {
    const root = (0,react_dom_client__WEBPACK_IMPORTED_MODULE_1__.createRoot)(servicesDiv);
    root.render(/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(Services, {}));
  } else {
