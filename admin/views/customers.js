...
/***/ "./admin/assets/images/avatar.png":
/*!****************************************!*\
  !*** ./admin/assets/images/avatar.png ***!
  \****************************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "images/avatar.5bf06071.png";
...
/*!*****************************************!*\
  !*** ./admin/views-react/customers.jsx ***!
  \*****************************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var _assets_images_avatar_png__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../assets/images/avatar.png */ "./admin/assets/images/avatar.png");
...
const Customers = () => {
  ...
  const handleSubmit = async e => {
    ...
    try {
      const response = await fetch(`${bookingProNonce.api_base_url}add-bp-user`, {
        method: "POST",
        headers: {
  ...
  const fetchUsers = () => {
    ...
    fetch(`${bookingProNonce.api_base_url}bp-users?page=${currentPage}&limit=${itemsPerPage}&search=${searchQuery}`,
    // Use backticks here
    {
      method: "GET",
      headers: {
  ...
  const handleDelete = async id => {
    ...
    if (confirmDelete) {
      try {
        const response = await fetch(`${bookingProNonce.api_base_url}delete-bp-user/${id}`, {
          method: "DELETE",
          headers: {
            "X-WP-Nonce": bookingProNonce.nonce,
            // Send the nonce for security
            "Content-Type": "application/json"
          }
        });
        const result = await response.json();
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.Fragment, {
    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("div", {
      ...
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(_components_Header__WEBPACK_IMPORTED_MODULE_3__["default"], {
        ...
        className: "bp-cus-content",
        children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("div", {
          className: "bp-cus-cont-inner",
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("div", {
            className: "bpdci-top",
            ...
            children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("table", {
              children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("thead", {
                ...
                children: customers.map((user, index) => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("tr", {
                  className: "bpd-table-item",
                  children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("td", {
                    children: [index + 1, " ", user.id]
                  }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("td", {
                    children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("img", {
                      src: user.profile_photo ? user.profile_photo : _assets_images_avatar_png__WEBPACK_IMPORTED_MODULE_4__,
                      alt: "",
                      style: {
                        width: "30px",
                        borderRadius: "20px"
                    ...
                    children: user.name ? user.name : "Not Found"
                  }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("td", {
                    children: user.email ? user.email : "Not Found"
                  }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("td", {
                    children: user.phone ? user.phone : "Not Found"
                  }), /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("td", {
          ...
          }), customers.length > itemsPerPage && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("div", {
        ...
        children: isOpen && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("div", {
          ...
          children: /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("div", {
            ...
            children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)("h2", {
              ...
              children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("div", {
                className: "cus-form-inner",
                children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsxs)("div", {
                  className: "cusf-first",
...
const initCustomers = () => {
  ...
  if (customersDiv) {
    const root = (0,react_dom_client__WEBPACK_IMPORTED_MODULE_1__.createRoot)(customersDiv);
    root.render(/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_5__.jsx)(Customers, {}));
  } else {
