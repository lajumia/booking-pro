  ...
  const renderStep = () => {
    switch (currentStep) {
          ...
          <fieldset>
            ...
            <div className="services">
              {service && service.length > 0 ? (
                ...
                <span>
                  Service not found. Please add a service from the admin panel.
                </span>
              )}
            </div>
          ...
          <fieldset>
            ...
            <div className="services staff">
              {staff && staff.length > 0 ? (
                ...
                <span>
                  Staff not found. Please add staff from the admin panel.
                </span>
              )}
            </div>
      ...
      case 5:
        return (
          <fieldset>
            <h2 className="fs-title">Payments</h2>
            <div className="services">
